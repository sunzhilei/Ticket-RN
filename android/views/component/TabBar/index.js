...
import { Dimensions, View, Animated, ScrollView, Platform, StyleSheet, ViewPagerAndroid, InteractionManager, } from 'react-native';
...
const IndexView = React.createClass({
    ...
    render() {
        ...
        let tabBarProps = {
            ...
            tabLabel: this._children().map((child) => child.props.tabLabel),
            tabImage: this._children().map((child) => child.props.tabImage),
